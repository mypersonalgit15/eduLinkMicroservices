package com.cts.iam_service.security;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        boolean isPublicPath = path.equals("/appUser/register") ||
                path.startsWith("/appUser/findAppUserByEmail/") ||
                path.startsWith("/appUser/findAppUserNameByAppUserId/") ||
